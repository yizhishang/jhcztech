...
<form action="edit.action" method="post" target="hiddenFrame" id="addForm">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
    <tr>
      <td><div class="title">
          <p><img src="${ctxPath }/admin/images/ico04.gif" />编辑模板</p>
        </div></td>
    </tr>
    <tr>
              ...
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="editortable">
                ...
                <tr>
                  ...
                  <td><select name="form.type" id="type" class="select" style="width:117px;">
					...
					<script type="text/javascript">setSelectSelected("form.type","${form.type}")</script>
                    <font color="#FF0000">*</font></td>
                </tr>
				<tr>
                  ...
                  <td><select name="form.encoding" id="encoding" class="select" style="width:117px;">
					...
					<script type="text/javascript">setSelectSelected("form.encoding","${form.encoding}")</script>
                    <font color="#FF0000">生成文件的编码，缺省为配置文件指定的编码</font></td>
                </tr>
                <tr id="tr_filepath" style="display:${(form.type eq '4')?'block':'none'}">
                  <td width="120" class="label">发布文件路径：</td>
                  <td><input type="text" name="form.filePath" id="filePath" value="${form.filePath}" class="input02" style="width:300px;"/>
                    <font color="#FF0000">*<br>(必须指定相对应用根目录的完整路径：例:/main/catalog/index.shtml)</font></td>
                </tr>
				<tr>
                  <td width="120" class="label">有效状态：</td>
                  <td>
                    <input type="radio" name="form.state" value="0">无效
                    <input type="radio" name="form.state" value="1">有效
					<script language="javascript">setRadioChecked("form.state", "<c:out value='${form.state}'/>")</script>
				  </td>
                </tr>
                <tr>
                  <td width="120" class="label">模板内容：</td>
                  <td><textarea class="input02" name="form.content" id="content" style="width:580px;height:150px;"><c:out value="${form.content}" escapeXml="true"/></textarea></td>
                </tr>
                <tr>
                  <td class="label">&nbsp;</td>
                  <td>
