...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#orderline").formValidator().inputValidator({min:1,onerror:"排序值不能为空,请确认！"}).regexValidator({regexp:regexEnum.num,onerror:"排序值只能为数字,请确认"});
		...
		var inputType = '${form.input_type}';
		$("#input_type").val(inputType).change();
		
	});
</script>
<form action="catalog.action" method="post" target="hiddenFrame" id="addForm">
  <input type="hidden" name="function" value="editField"/>
  <input type="hidden" name="form.id" value="${param.id}"/>
  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
    <tr>
      <td><div class="title">
          <p><img src="${ctxPath }/admin/images/ico04.gif" />修改文档自定义字段</p>
        </div></td>
    </tr>
    <tr>
            ...
            <td><div class="space"></div>
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="editortable">
                ...
                <tr>
                  ...
                  <td><input type="radio" name="form.ismandatory" value="1"/>是 <input type="radio" name="form.ismandatory" value="0" checked="checked"/>否
				  <script language="javascript">setRadioChecked('form.ismandatory','${form.ismandatory}')</script>
				  </td>
                </tr>
                ...
                <tr id="trMaxNum">
                  ...
                  <td><input type="text" name="form.max_num"  id="max_num" class="input02" style="width:116px;" value="${form.max_num}"/> <font color="#FF0000">*</font></td>
                </tr>
				<tr>
                  <td width="120" class="label">排序值：</td>
                  <td><input type="text" name="form.orderline"  id="orderline" class="input02" style="width:116px;" value="${form.orderline}"/> <font color="#FF0000">(请输入数字,值大的排前面)</font></td>
                </tr>
				 <tr id="textWH" style="display:none">
                  <td width="120" class="label">宽度：</td>
                  <td><input type="text" name="form.width"  id="width" class="input02" style="width:116px;" value="${form.width}"/> <font color="#FF0000">*</font></td>
                </tr>
				 <tr id="textWH" style="display:none">
                  <td width="120" class="label">高度：</td>
                  <td><input type="text" name="form.height"  id="height" class="input02" style="width:116px;" value="${form.height}"/> <font color="#FF0000">*</font></td>
                </tr>
				<tr id="extendContent" style="display:none">
                  <td width="120" class="label">列表选项<BR/><font color="#FF0000">(每行为一个列表项)</font>：</td>
                  <td><textarea class="input02" name="form.extend_content" id="extend_content" style="width:240px;height:80px;">${form.extend_content}</textarea> <font color="#FF0000">*</font></td>
                </tr>
                <tr>
                  <td class="label">&nbsp;</td>
