...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  ...
  <tr>
    <td class="edinner" valign="top" style="width:100%"><form action="branchMaintain.action" method="post" id="enterForm" target="hiddenFrame">
		...
		<input type="hidden" name="form.infoid" id="id" value="${form.infoid}"/>
              ...
              <div id="divContainer" style="overflow-y: auto;overflow-x:hidden;width:100%;">
                <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="editortable">
                  <tr>
                    ...
                    <td ><input type="text" name="form.title" id="title" class="input02" style="width:250px;" value="${form.title}"/>
                  ...
                  <tr>
                    ...
                    <td><select name="form.branchno" id="branchNo" style="width:150px;">
					  ...
					  <script type="text/javascript">setSelectSelected("form.branchno","${form.branchno}")</script>
					  </td>
                  </tr>
				  </c:when>
				  <c:otherwise>
				  <input type="hidden" name="form.branchno" value="${form.branchno}"/>
				  </c:otherwise>
				  </c:choose>
                  <tr>
