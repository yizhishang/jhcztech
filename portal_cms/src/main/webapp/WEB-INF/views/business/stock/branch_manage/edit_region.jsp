...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#ordernum").formValidator().regexValidator({regexp:regexEnum.notempty,onerror:"排序值不能为空,请确认"}).regexValidator({regexp:regexEnum.intege,onerror:"排序值只能为数字,请确认"});
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  <tr>
    <td>
        <div class="title">
            <p><img src="${ctxPath }/admin/images/ico04.gif" />编辑<span class="ColumnDisplay">区域信息</span></p>
        </div>
    </td>
  </tr>
  <tr>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="editortable">
			  ...
			  <tr>
                ...
                <td><select name="form.area" style="width:120px" id="area">
						  ...
						  <script langauge="javascript">setSelectSelected("form.area","<c:out value='${form.area}'/>")</script>
						  </td>
              </tr>
			  <tr>
                <td width="120" class="label">排序值：</td>
                <td><input type="text" name="form.ordernum" id="ordernum" class="input02" style="width:116px;" value="<c:out value='${form.ordernum}'/>"/><font color="#ff0000">*</font>(请输入数字)
						  </td>
              </tr>
              <tr>
                <td class="label">&nbsp;</td>
