    ...
    $.fn.jBootstrapPage = function(config) {
        ...
        return this.each(function() {
            ...
            function init() {
            	...
            	$this.append('<li class="disabled" style="display: none;"><a class="first" href="#"></a></li>');
            	$this.append('<li class="disabled" ><a class="pre" href="#"><img src="/component/app/images/news/arrow_last.png">&nbsp;&nbsp;上一页</a></li>');
        		...
        		$this.append('<li><a class="next" href="#">下一页&nbsp;&nbsp;<img src="/component/app/images/news/arrow_next.png"></a></li>');
        		$this.append('<li><a class="last" style="display: none;" href="#"></a></li>');
                ...
                /* 初始化判断 */
                var pageNum=Number(c.total)/Number(c.pageSize);
                if (pageNum<=1) {
            ...
            function onPageBtnClick($_this) {
            	...
            	if(selectedText.indexOf("下") !=-1 || selectedText == '»') {
            	...
            	else if(selectedText.indexOf("上") !=-1  || selectedText == '«') {
