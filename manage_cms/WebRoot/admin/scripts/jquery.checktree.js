...
(function(jQuery) {
    ...
    jQuery.fn.checkTree = function(settings) {
		...
		.find("span :checkbox")
			.click(function(){
				//�жϵ�ǰ�е�checkbox��û�б�ѡ�У�����У��򽫵�ǰ�����ڽڵ�����Ϊѡ��״̬
				var $span = jQuery(this).parent().parent();
				
				var $bool = false;
				$span.find("span :checkbox").each(function(){
				...
				if($bool)
				{
					if(!$span.parent().find(".checkbox").hasClass("checked"))
					{
						$span.parent().find(".checkbox").click();
					}
				}
				else
				{
        ...
        .each(function() {
            ...
            $checkbox.click(function() {
                ...
                if (jQuery(this).hasClass("checked")) {
					...
					// add
					jQuery(this).parent().find("span :checkbox").attr("checked","checked");
                }
                else {
					...
					// add
					jQuery(this).parent().find("span :checkbox").attr("checked","");
                }
			...
			// add
			jQuery(this).find("span :checkbox").each(function(){
				jQuery(this).show();
			});
