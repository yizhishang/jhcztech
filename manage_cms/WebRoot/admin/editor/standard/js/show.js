...
if (config.StateFlag=="1"){
	...
	document.write ("	</td>");
	// 原厂版权标识
	//document.write ("	<td><a href='http://www.ewebeditor.com' target='_blank'><font color=#000000>eWebEditor.com</font></a>&nbsp;<a href='http://www.ewebeditor.com/order.asp' target='_blank'>Buy Now</a></td>");
	// 自定义版权标识
	//document.write ("	<td><a href='http://www.ixuer.net/' target='_blank'><font color=#000000>iXuEr.Net</font></a></td>");
	document.write ("	<td align=right>");
	document.write ("		<table border=0 cellpadding=0 cellspacing=0 height=20>");
	document.write ("		<tr>");
	document.write ("		<td style='cursor:pointer;' onclick='sizeChange(65)'><img border=0 SRC='buttonimage/" + config.ButtonDir + "/sizeplus.gif' width=20 height=20 alt='" + lang["SizePlus"] + "'></td>");
	document.write ("		<td width=5></td>");
	document.write ("		<td style='cursor:pointer;' onclick='sizeChange(-65)'><img border=0 SRC='buttonimage/" + config.ButtonDir + "/sizeminus.gif' width=20 height=20 alt='" + lang["SizeMinus"] + "'></td>");
	document.write ("		<td width=5></td>");
	// By Guidy 2005-11-05
	if (sFullScreen=="1"){
		document.write ("		<td style='cursor:pointer;' onclick='parent.Minimize()'><img border=0 SRC='buttonimage/" + config.ButtonDir + "/minimize.gif' width=20 height=20 alt='" + lang["Minimize"] + "'></td>");
	}else{
		document.write ("		<td style='cursor:pointer;' onclick='Maximize()'><img border=0 SRC='buttonimage/" + config.ButtonDir + "/maximize.gif' width=20 height=20 alt='" + lang["Maximize"] + "'></td>");
	}
	document.write ("		<td width=10></td>");
	document.write ("		</tr>");
	document.write ("		</table>");
