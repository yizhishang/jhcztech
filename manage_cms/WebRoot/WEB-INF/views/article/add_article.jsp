            ...
            <td><div class="space"></div>
              ...
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="editortable" id="tab1" style="display:none">
                ...
                <tr>
                  ...
                  <td><input type="checkbox" value="1" id="pictureNews"/>
                    图片新闻
                    <input type="checkbox" value="1" id="hotNews"/>
                    推荐
                    <input type="checkbox" value="1" id="headNews"/>
                    置顶</td>
                </tr>
                <tr style="display:none" id="trIsPicture">
                  <td class="label">图片地址：</td>
                  <td><input type="text" name="form.pictureUrl" id="pictureUrl" class="input02" style="width:300px;" readonly="true" value="<c:out value='${form.pictureUrl}'/>"/>
