...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  <tr>
    <td>
        <div class="title">
            <p><img src="${ctxPath }/admin/images/ico04.gif" />添加专家信息</p>
        </div>
    </td>
  </tr>
  <tr>
            ...
            <td><div class="space"></div>
              <div id="divContainer" style="overflow-y: auto;overflow-x:hidden;width:100%;">
                <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="editortable">
                  ...
                  <tr>
                    <td width="120" class="label"><span class="DetailTagText">选择用户</span>：</td>
                    <td><select name="form.expid">
                        <c:forEach var="item" items="${data.userList}">
                  ...
                  <tr>
                    ...
                    <td >
                      <input type="text" name="form.name" id="name" class="input02" style="width:150px;"/> <font color="#ff0000">*</font></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">学历</span>：</td>
                    <td><input type="text" name="form.school" id="school" class="input02" style="width:150px;"/></td>
                  </tr>
                  <tr>
                    <td  class="label"><span class="DetailTagText">所属部门名称</span>：</td>
                    <td><input type="text" name="form.deptname" id="deptname" class="input02" style="width:150px;"/></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">专业职称</span>：</td>
                    <td ><input type="text" name="form.title" id="title" class="input02" style="width:150px;"/></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">从业资格</span>：</td>
                    <td ><input type="text" name="form.certificate" id="certificate" class="input02" style="width:150px;"/></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">从业时间</span>：</td>
                    <td ><input type="text" name="form.jobtime" id="jobtime" class="input02" style="width:150px;"/>
                  ...
                  <tr>
                    ...
                    <td ><input type="text" name="form.telephone" id="telephone" class="input02" style="width:150px;"/></td>
                  </tr>
				  <tr>
                  ...
                  <tr>
                    ...
                    <td ><textarea name="form.service" id="service" class="input02" style="width:460px;height:70px;"><c:out value='${form.service}'/>
</textarea></td>
                  </tr>
                  
                  <tr>
                    <td class="label"><span class="DetailTagText">专家介绍</span>：</td>
                    <td ><textarea name="form.intro" id="intro" class="input02" style="width:460px;height:70px;"><c:out value='${form.service}'/>
</textarea></td>
                  </tr>
                  <tr>
                    <td colspan="4" style="height:8px;"></td>
