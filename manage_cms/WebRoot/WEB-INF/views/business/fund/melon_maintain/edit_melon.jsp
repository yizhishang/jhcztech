...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" >
  <tr>
    <td>
        <div class="title">
            <p><img src="${ctxPath }/admin/images/ico04.gif" />修改基金分红信息</p>
        </div>
    </td>
  </tr>
  <tr>
        ...
        <td>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="editortable">
              ...
              <tr id="wfsyl">
                ...
                <td><textarea rows="5" cols="50" name="form.remark" class="input02" style="height:80px;"><c:out value="${form.remark }"/></textarea>
                  </td>
              </tr>
              <tr>
                <td class="label">&nbsp;</td>
