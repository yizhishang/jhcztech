...
import com.jhcz.base.util.CharHelper;
...
import com.jhcz.plat.service.AttachService;
...
import com.jhcz.plat.template.TemplatePreview;
    ...
    public String doPublishArticleRecursio()
    {
        ...
        if (1 == isPublish && 1 == isPublishArticle)
        {
            ...
            for (Iterator<Object> catalogIter = catalogList.iterator(); catalogIter.hasNext();)
            {
                ...
                articleList = articleService.findPublishArticleById(catalog.getInt("catalog_id"), rows);
    ...
    public String doReject()
    {
        if (isPostBack())
        {
            ...
            for (int i = 0; i < idArray.length; i++)
            {
                ...
                String url = service.findUrlById(articleId);
