...
import com.yizhishang.base.util.PropHelper;
import com.yizhishang.base.util.StringHelper;
import com.yizhishang.base.util.security.AES;
    ...
    private static void loadConfig()
    {
        ...
        if (file != null && file.exists() && file.isFile()) {
            ...
            try {
                ...
                @SuppressWarnings("unchecked") List<Element> funcElementList = rootElement.elements("datasource");
                ...
                for (Iterator<Element> iter = funcElementList.iterator(); iter.hasNext(); ) {
                    ...
                    @SuppressWarnings("unchecked") List<Element> propElementList = dsElement.elements("property");
