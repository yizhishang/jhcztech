...
public class ExcelHelper
{
     ...
     */
    public static Map<String, Object> readExcel(File file, int[] columnNum, String[] fieldsName, boolean hasTitle,
                                                Map<String, Object> dafaultValue)
    {
        if (file.isFile()) {
     ...
     * @throws IOException
     */
    public static Map<String, Object> readExcel(InputStream inputStream, String[] fieldsName, boolean hasTitle)
            throws IOException
    {
     ...
     * @throws IOException
     */
    public static Map<String, Object> readExcel(InputStream inputStream, int[] columnNum, String[] fieldsName,
                                                boolean hasTitle) throws IOException
    {
     ...
     */
    public static Map<String, Object> readExcel(InputStream inputStream, int[] columnNum, String[] fieldsName,
                                                boolean hasTitle, Map<String, Object> dafaultValue) throws IOException
    {
        if (inputStream == null) {
            return null;
        }
                ...
                if (row != null) {
                    ...
                    if (columnNum != null && columnNum.length > 0) {
                        for (int k = 0; k < columnNum.length; k++) {
                            ...
                            if (cell != null) {
                                String key = (fieldsName != null && fieldsName.length >= k) ? fieldsName[k] : String
                                        .valueOf(k);
        ...
        for (Iterator<HSSFPictureData> iter = list.iterator(); iter.hasNext(); ) {
            ...
            if (StringHelper.isNotEmpty(outDirectory)) {
                ...
                if (outDirectory.endsWith(File.separator)) {
                    ...
                    FileHelper.writeToFile(outDirectory + File.separator + "picture_" + i + suffix, pictureData
                            .getData());
                }
            } else {
     ...
     * @return
     */
    public static HSSFWorkbook createExcel(List<DynaModel> list, String[] titles, String[] mappingFileds, int[]
            columnWidth, boolean hasIndex)
    {
        return createExcel(null, list, titles, mappingFileds, columnWidth, null, null, null, null, null, null,
                hasIndex);
    }
     ...
     * @return
     */
    public static HSSFWorkbook createExcel(HSSFWorkbook workbook, List<DynaModel> list, String[] titles, String[]
            mappingFileds, int[] columnWidth, boolean hasIndex)
    {
        return createExcel(workbook, list, titles, mappingFileds, columnWidth, null, null, null, null, null, null,
                hasIndex);
    }
    ...
    public static HSSFWorkbook createExcel(HSSFWorkbook workbook, List<DynaModel> list, String[] titles, String[]
            mappingFileds, int[] columnWidth, HSSFCellStyle titleStyle, int[] rows, HSSFCellStyle[] rowsStyle, int[]
            column, HSSFCellStyle[] columnsStyle, HSSFCellStyle otherStyle, boolean hasIndex)
    {
        if (list.isEmpty()) {
            return null;
        } else {
                        ...
                        if (title.indexOf(":") != -1) {
                            ...
                            if (cTitle.indexOf(",") != -1) {
                                ...
                                for (int j = 0; j < cTitles.length; j++) {
                                    ...
                                    workbook.setRepeatingRowsAndColumns(workbook.getSheetIndex(sheet), 0, 0, i, i + j
                                            + 1);
                                }
     ...
     */
    public static void export(HttpServletRequest request, HttpServletResponse response, HSSFWorkbook wb, String
            fileName)
    {
        if (wb == null) {
