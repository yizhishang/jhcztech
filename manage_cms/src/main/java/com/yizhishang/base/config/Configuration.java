    ...
    private static void loadConfig()
    {
        ...
        if (configFile != null && configFile.exists() && configFile.isFile()) {
            ...
            try {
                ...
                @SuppressWarnings("unchecked") List<Element> catList = systemElement.elements("category");
                for (Iterator<Element> catIter = catList.iterator(); catIter.hasNext(); ) {
                    ...
                    @SuppressWarnings("unchecked") List<Element> itemList = catElement.elements("item");
