 ...
 */
@Service
public class ManageCatalogServiceImpl extends BaseService implements ManageCatalogService
{
    ...
    */
    ...
    public void addCatalog(ManageCatalog catalog)
    {
        ...
        ManageCatalogDao catalogDao = (ManageCatalogDao) getDao(ManageCatalogDao.class);
