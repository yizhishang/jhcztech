...
public class PublishCallBack implements WorkCallBack
{
    ...
    private static PublishQueueService publishQueueService = (PublishQueueService) SpringContextHolder.getBean
            ("publishQueueService");

    private static CatalogService catalogService = (CatalogService) SpringContextHolder.getBean("catalogService");

    private static PublishLogService publishLogService = (PublishLogService) SpringContextHolder.getBean
            ("publishLogService");
