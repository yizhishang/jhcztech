package com.yizhishang.plat.web.interceptors;
...
public class SecurityInterceptor extends HandlerInterceptorAdapter
{
    ...
    private boolean hasPermission(HttpServletRequest request)
    {
        ...
        if (rightUrl.indexOf("index.action") != -1 || rightUrl.indexOf("top.action") != -1 || rightUrl.indexOf("left"
                + ".action") != -1 || rightUrl.indexOf("right.action") != -1 || rightUrl.indexOf("login.action") !=
                -1 || rightUrl.indexOf("getTicket.action") != -1 || rightUrl.indexOf("loginValidate.action") != -1 ||
                rightUrl.indexOf("reLogin.action") != -1) {
            return true;
        }
    ...
    {
        String uri = request.getRequestURI();
        if (uri.indexOf("login.action") > -1 || uri.indexOf("reLogin.action") > -1 || uri.indexOf("getTicket.action")
                > -1 || uri.indexOf("loginValidate.action") > -1) {
            return true;
        }
