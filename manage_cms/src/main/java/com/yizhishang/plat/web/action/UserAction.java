...
public class UserAction extends BaseAction
{
    ...
    public ModelAndView doDefault()
    {
        ...
        String siteno = getSiteNo();
        DBPage<Map> page = userService.getPageData(curPage, SysConfig.getRowOfPage(), siteno, keyword, branchno,
                roleid);
        /**
         * 查询用户所属的角色名称
         *  by 20130522
    ...
    private void exportToExcel(List<DynaModel> list, String value, HttpServletRequest request) throws Exception
    {
         ...
         */
        //String fileName = "/opt/web/xls/" + value +"(" + String.valueOf(hour) + String.valueOf(minute) + String
        // .valueOf(second) +")" + ".xls";
        String fileName = value + "(" + String.valueOf(hour) + String.valueOf(minute) + String.valueOf(second) + ")"
                + ".xls";
