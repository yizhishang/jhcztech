...
function SelectColor(what){
	...
	var arr = showModalDialog(url,window,"dialogWidth:"+lang["UIselcolorWidth"]+"px;dialogHeight:"+lang["UIselcolorHeight"]+"px;help:no;scroll:no;status:no");
	if (arr) {
		dEL.value=arr;
...
function SelectImage(){
	showModalDialog("backimage.htm?action=other",window,"dialogWidth:"+lang["UIbackimageWidth"]+"px;dialogHeight:"+lang["UIbackimageHeight"]+"px;help:no;scroll:no;status:no");
}
