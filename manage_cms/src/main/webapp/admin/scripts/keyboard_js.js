...
tablewidth=520;  // logo width, in pixels
...
//显示软键盘
	...
	{
		if(event.y+140)
		softkeyboard.style.top=event.y+document.body.scrollTop-210;

		if((event.x-250)>0)
		{
			softkeyboard.style.left=event.x-198;
		}
		else
		{
