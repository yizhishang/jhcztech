...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  <tr>
    <td>
        <div class="title">
           <p><img src="${ctxPath }/admin/images/ico04.gif" />添加${data.tableinfo.name_ch }信息</p>
        </div>
    </td>
  </tr>
  <tr>
            ...
            <table width="98%" border="0" align="top" cellpadding="0" cellspacing="0" class="editortable">
              ...
              <c:choose>
				...
				<c:when test="${colitem.show_in_info == 'N'}">
					<input type="hidden" id="${colitem.name_en }"  name="form.${colitem.name_en }"  value="<c:out value='${colitem.default_value }'/>" />
				</c:when>
			  </c:choose>
              </c:forEach>
			  <tr>
