...
<link href="${ctxPath }/admin/styles/cms.css" rel="stylesheet" type="text/css" />
...
<div class="eb0">
  <ul class="menu">
    ...
    <li class="${(param.type eq '1')?'cur':'no'}"><a href="javascript:void(0);" onClick="attachPublish();" title="附带发布"><img src="${ctxPath }/admin/images/ico17.gif" border="0"/>附带发布</a></li>
	<li class="${(param.type eq '2')?'cur':'no'}"><a href="javascript:void(0);" onClick="seo();" title="SEO设置"><img src="${ctxPath }/admin/images/ico17.gif" border="0"/>SEO设置</a></li>
