                    ...
                    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="editortable" id="tab1">
                        ...
                        <tr>
                          ...
                          <td><input type="text" name="form.smallImage" id="smallImage" class="input02" style="width:300px;"  value="<c:out value='${form.smallImage}'/>"/>
                            ...
                            <input type="button"onClick="openDeleteFileDialog($('#smallImage'))" value="删除" class="bt01"/></td>
                        </tr>
                        <tr>
                          <td class="label"><span class="DetailTagText">栏目图片(大)</span>：</td>
                          <td><input type="text" name="form.largeImage"  id="largeImage" class="input02" style="width:300px;"   value="<c:out value='${form.largeImage}'/>"/>
                            <input type="button" onClick="openUploadFileDialog($('#largeImage'))" value="上传文件" class="bt02"/>
                            <input type="button"onClick="openDeleteFileDialog($('#largeImage'))" value="删除" class="bt01"/></td>
                        </tr>
                        <tr>
                          <td class="label">&nbsp;</td>
