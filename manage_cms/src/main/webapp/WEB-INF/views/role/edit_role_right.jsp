...
$(function(){
	...
	$("#siteNo").change(function(){
		location.href='role.action?function=editRoleRight&roleId=${param.roleId}&siteNo=' + $(this).val();
	});
	$("#siteNo").val("${param.siteNo}");
});
</script>
<body>
                    ...
                    <tr>
                      <td width="43%"><div class="setbox">
                          ...
                          <ul class="children_ul">
                            <iframe name="leftFrame" id="leftFrame" src="doCatalogTree.action?roleId=<%=RequestHelper.getString(request,"roleId") %>&siteNo=<%=RequestHelper.getString(request,"siteNo") %>&type=0" width="99%" height="380"></iframe>
                          </ul>
                        </div></td>
                      ...
                      <td width="43%"><div class="setbox">
                          ...
                          <ul class="children_ul">
                            <iframe name="rightFrame" id="rightFrame" src="doCatalogTree.action?roleId=<%=RequestHelper.getString(request,"roleId") %>&siteNo=<%=RequestHelper.getString(request,"siteNo") %>&type=1" width="99%" height="380"></iframe>
                          </ul>
                        </div></td>
                    </tr>
                  </table>
