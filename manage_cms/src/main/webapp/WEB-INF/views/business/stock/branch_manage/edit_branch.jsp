...
<script type="text/javascript">	
	...
	$(document).ready(function(){
		...
		$("#ordernum").formValidator().regexValidator({regexp:regexEnum.notempty,onerror:"排序值不能为空，请确认"}).regexValidator({regexp:regexEnum.num,onerror:"排序值格式不正确，请输入数字"});
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  ...
  <tr>
    <td class="edinner" valign="top" style="width:100%"><form action="branchManage.action" method="post" id="enterForm" target="hiddenFrame">
		...
		<input type="hidden" name="form.branchid" value="<c:out value='${form.branchid}'/>">
              ...
              <div id="divContainer" style="overflow-y: auto;overflow-x:hidden;width:100%;">
                <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="editortable">
                  ...
                  <tr>
                    ...
                    <td> <c:out value='${form.branchno}'/></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">营业部名称</span>：</td>
                    <td ><input type="text" name="form.branchname" id="branchname" value="${form.branchname}" class="input02" style="width:150px;"/>
                  ...
                  <tr>
                    ...
                    <td><select name="form.region" style="width:150px;">
					  ...
					  <script type="text/javascript">setSelectSelected("form.region","${form.region}")</script>
					  </td>
                  </tr>
                  <tr>
                    <td  class="label"><span class="DetailTagText">营业部城市</span>：</td>
                    <td><input type="text" name="form.city" id="city" value="${form.city}" class="input02" style="width:150px;"/></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">营业部地址</span>：</td>
                    <td ><input type="text" name="form.address" id="address" value="${form.address}"  class="input02" style="width:150px;"/></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">营业部博客</span>：</td>
                    <td><input type="text" name="form.blog" id="blog" value="${form.blog}" class="input02" style="width:150px;"/></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">客户资金存管银行</span>：</td>
                    <td><input type="text" name="form.bank" id="bank" value="${form.bank}" class="input02" style="width:150px;" /></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">交易品种</span>：</td>
                    <td><input type="text" name="form.breed" id="breed" value="${form.breed}" class="input02" style="width:150px;"/></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">沪A/沪B席位</span>：</td>
                    <td><input type="text" name="form.sha_shb" id="sha_shb" value="${form.sha_shb}" class="input02" style="width:150px;"/>
                      <font color="red">A股席位号与B席位号股请用“/”分割</font></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">深A/深B席位</span>：</td>
                    <td><input type="text" name="form.sza_szb" id="sza_szb" value="${form.sza_szb}" class="input02" style="width:150px;"/>
                      <font color="red">A股席位号与B席位号股请用“/”分割</font></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">邮编</span>：</td>
                    <td><input type="text" name="form.postcode" id="postcode" value="${form.postcode}" class="input02" style="width:150px;"/></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">委托电话</span>：</td>
                    <td><input type="text" name="form.entrustphone" id="entrustphone" value="${form.entrustphone}" class="input02" style="width:150px;"/></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">服务电话</span>：</td>
                    <td><input type="text" name="form.servicephone" id="servicephone" value="${form.servicephone}" class="input02" style="width:150px;"/></td>
                  </tr>
                  <tr>
                    <td class="label"><span class="DetailTagText">邮箱地址</span>：</td>
                    <td><input type="text" name="form.email" id="email" value="${form.email}" class="input02" style="width:150px;"/></td>
                  </tr>
				  <tr>
                    <td class="label"><span class="DetailTagText">排序值</span>：</td>
                    <td><input type="text" name="form.ordernum" id="ordernum" value="${form.ordernum}" class="input02" style="width:150px;"/></td>
                  </tr>
                  <tr>
				  ...
				  <tr>
                    ...
                    <td><input type="text" name="form.lat" id="lat" value="${form.lat}" class="input02" style="width:150px;"/></td>
                  </tr>
				  <tr>
                    <td class="label"><span class="DetailTagText">经度</span>：</td>
                    <td><input type="text" name="form.lnt" id="lnt" value="${form.lnt}" class="input02" style="width:150px;"/></td>
                  </tr>
				  <tr>
                    <td class="label"><span class="DetailTagText">放大倍数</span>：</td>
                    <td><input type="text" name="form.zoom" id="zoom" value="${form.zoom}" class="input02" style="width:150px;"/></td>
                  </tr>
				  <tr>
                    <td class="label"><span class="DetailTagText">细览时的放大倍数</span>：</td>
                    <td><input type="text" name="form.maxzoom" id="maxzoom" value="${form.maxzoom}" class="input02" style="width:150px;"/></td>
                  </tr>
                  <tr>
                    <td colspan="4" style="height:8px;"></td>
                  </tr>
